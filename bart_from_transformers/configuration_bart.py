...
BART_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "facebook/bart_from_transformers-base": "https://s3.amazonaws.com/models.huggingface.co/bert/facebook/bart-base/config.json",
    "facebook/bart_from_transformers-large": "https://s3.amazonaws.com/models.huggingface.co/bert/facebook/bart-large/config.json",
    "facebook/bart_from_transformers-large-mnli": "https://s3.amazonaws.com/models.huggingface.co/bert/facebook/bart-large-mnli/config.json",
    "facebook/bart_from_transformers-large-cnn": "https://s3.amazonaws.com/models.huggingface.co/bert/facebook/bart-large-cnn/config.json",
    "facebook/bart_from_transformers-large-xsum": "https://s3.amazonaws.com/models.huggingface.co/bert/facebook/bart-large-xsum/config.json",
...
class BartConfig(PretrainedConfig):
    ...
    """
    model_type = "bart_from_transformers"
        ...
        **common_kwargs
        ...
        r"""
            ...
            Examples::
                ...
                >>> config = BartConfig.from_pretrained('facebook/bart_from_transformers-large')
